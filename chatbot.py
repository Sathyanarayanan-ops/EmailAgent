...
#     """
#     mails_dict = state.get("mails")
#     print("MAILS KEY ",mails_dict.key())

#     if not mails_dict.strip():
#         return {"summary": "No email content to summarize."}
#     for id in mails_dict:
#         summary = iterative_summarize_emails(mails_dict[id])
#     return {"summary": summary}
